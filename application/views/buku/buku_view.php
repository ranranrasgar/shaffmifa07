<div class="">
    <div class="page-title" style="padding: 8px">
        <div class="title_left">
            <h1><i class="fa fa-book"></i>  Inventaris</h1>
        </div>
    </div>
    <?php if($this->session->userdata('role')=='superadmin'): ?>
    <a href="<?php echo base_url() ?>buku/add" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Tambah Inventaris</a>
    <?php endif; ?>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>List Data <small>Inventaris</small></h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                <!-- Notif -->
                        ...
                        <?php foreach ($list as $bookList):?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger btn-xs" onclick="sweets('<?php echo $bookList->ID_BUKU ?>')">
...
function sweets(id) {
    swal({
        ...
        function() {
            window.location.href = "<?php echo base_url() ?>buku/delete?rcgn=" + id;
        });
}
</script>

...
<html lang="en">
    ...
    <head>
        ...
        <title>Setup - Shaff Mufa 07</title>
                ...
                <div>
                    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 form-box">
                        <form role="form" action="<?php echo base_url() ?>setup/submit" method="post" class="f1">
                            ...
                            <h3>Setup Aplikasi Shaff Mufa 07</h3>
                            ...
                            <fieldset>
                                <h4>Data Paguyuban</h4>
                                <div class="form-group">
                                    <label class="sr-only">Nama Paguyuban</label>
                                    <input type="text" name="name" placeholder="Nama Paguyuban" class="f1-first-name form-control" id="f1-first-name">
                                </div>
                                <div class="form-group">

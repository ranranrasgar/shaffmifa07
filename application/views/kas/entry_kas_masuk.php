<div class="">
    <div class="page-title" style="padding: 8px">
        <div class="title_left">
            <h1 style="font-size: 24px;"><i class="fa fa-arrow-up"></i> Kas Masuk</h1>
        </div>
    </div>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php if (!empty($announce)) : ?>
                        ...
                        <?php endif; ?>
                    <?php endif; ?>
                    <!-- <form method="post" action="<?php echo base_url(); ?>kas/submit" role="form" enctype="multipart/form-data"> -->
                    <form method="post" action="<?php echo base_url(); ?>kas/submitKasMasuk" role="form" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="number" id="RP_MASUK" name="RP_MASUK" class="form-control" min="0" step="0.01" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                </div>
                            </div>
                            <div class="form-group">
